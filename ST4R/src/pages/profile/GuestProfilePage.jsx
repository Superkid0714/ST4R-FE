    ...
    <div className="min-h-screen bg-black text-white font-['Pretendard']">
      <div className="px-4 py-6">
        ...
        <div className="bg-[#1D1D1D] rounded-[10px] mb-4">
          ...
          >
            <div className="flex items-center space-x-4">
              {/* 기본 프로필 아이콘 */}
              <div className="w-12 h-12 bg-[#2F2F2F] rounded-full flex items-center justify-center">
                <svg
                  className="w-6 h-6 text-[#5F5F5F]"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="mt-8">
          <button
            onClick={handleAuthRequired}
            className="w-full h-14 bg-yellow-500 text-black rounded-lg font-bold text-lg hover:bg-yellow-400 transition-colors"
          >
            로그인하기
          </button>
        </div>
