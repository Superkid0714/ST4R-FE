...
export default function ImageViewer({
  ...
  return (
    <div className="fixed inset-0 bg-black z-50 flex items-center justify-center">
      ...
      <button
        onClick={onClose}
        className="absolute top-4 right-4 z-30 p-3 bg-black/70 hover:bg-black/90 rounded-full text-white transition-colors"
      ...
      {/* 이미지 카운터 */}
      {images.length > 1 && (
        <div className="absolute top-4 left-4 z-30 bg-black/70 rounded-full px-4 py-2 text-white text-sm font-medium">
      ...
      <button
        onClick={toggleZoom}
        className="absolute top-4 left-1/2 transform -translate-x-1/2 z-30 p-3 bg-black/70 hover:bg-black/90 rounded-full text-white transition-colors"
